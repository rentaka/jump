...
// ユーザ書き換え領域 - 開始 -
 ...
 // 常に演奏される足音
        always: {
            interval:1,
            walk1:{name:'fst_snow_light_walk_002.ogg', volume:90, pitch:100, pan:0},
            walk2:{name:'fst_snow_light_walk_001.ogg', volume:90, pitch:100, pan:0},
            dash1:{name:'fst_snow_light_walk_002.ogg', volume:90, pitch:100, pan:0},
            dash2:{name:'fst_snow_light_walk_002.ogg', volume:90, pitch:100, pan:0},
        },
        // 梯子属性通過時の足音
        ladder: {
            interval:1,
            walk1:{name:'fst_snow_light_walk_002.ogg', volume:90, pitch:100, pan:0},
            walk2:{name:'fst_snow_light_walk_002.ogg', volume:90, pitch:100, pan:0},
        ...
        counter: {
            interval:1,
            walk1:{name:'fst_snow_light_walk_001.ogg', volume:90, pitch:100, pan:0},
